...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.video.create')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="url" name="url" class="col-xs-10 col-sm-5" required="" value="{{ old('url')}}" />
        </div>
    </div>
    <div class="form-group">
