...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.pageSingle.edit', ['id'=>$id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="clearfix form-actions">
        <div class="col-md-offset-2 col-md-9">
            ...
            &nbsp; &nbsp; &nbsp;
            <a class="btn btn-success" href="{{ route('get.dashboard.pageSingle.list') }}">
