...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.teams.create')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="position" name="position" class="col-xs-10 col-sm-5" required="" value="{{ old('position')}}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Email </label>
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="email" name="email" class="col-xs-10 col-sm-5" required="" value="{{ old('email')}}" />
        </div>
    </div>
    <div class="form-group">
