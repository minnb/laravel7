...
<form class="form-horizontal" role="form" action="{{ route('post.dashboard.video.edit', ['id'=>$data['id']])}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="url" name="url" class="col-xs-10 col-sm-5" value="{{ old('url', isset($data) ? $data['url'] : '' ) }}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"></label>
        <div class="col-sm-9" style="align-content: center;">
            <iframe src="{{ $data['url'] }}" width="400" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen title=""></iframe>
        </div>
    </div>
    ...
    <div class="clearfix form-actions">
        <div class="col-md-offset-2 col-md-9">
            ...
            &nbsp; &nbsp; &nbsp;
            <a class="btn btn-success" href="{{ route('get.dashboard.video.list') }}">
