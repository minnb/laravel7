                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="red" href="{{ route('get.dashboard.post.delete', ['id'=>$item->id]) }}" onclick="return alertDelete();">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        ...
                                        <li>
                                            <a href="{{ route('get.dashboard.post.delete', ['id'=>$item->id]) }}" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return alertDelete();">
                                                <span class="red">
